...
public class AESHelper{
	...
	public static void main(String[] args) {
		...
		System.out.println(decryptStr(encryptStr(content, password), password));
		System.out.println(decryptStr(encryptStr(content2, password), password));
...
//		System.out.println("解密后：" + new String(decryptResult));
	 ...
	 * @return
	 */
	public static String encryptStr(String content,String pwd){
	 ...
	 * @return
	 */
	public static String decryptStr(String content,String pwd){
		byte[] decryptResult;
		decryptResult = decrypt(parseHexStr2Byte(content),pwd);
